...
const MenuSettings = () => {
    ...
    const onUpdatePlace = async () => {
        ...
        if (json) {
            toast("Les nouveaux paramètres sont mis à jour", {type: "success"});
            setPlace(json);
            setLoading(false);
        }
    }
    ...
    return (
        <MainLayout>
            <div className="d-flex align-items-center mb-4">
                ...
                <h3 className="mb-0 mr-2 ml-2">Paramètres des menus</h3>
            </div>
            ...
            <Row>
                ...
                <Col md={4}>
                    <Panel>
                        <Form.Group>
                            <Form.Label>Police de caractère</Form.Label>
